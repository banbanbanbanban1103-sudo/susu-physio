...
function renderCalendar() {
    ...
    // လအစ မတိုင်ခင် လပ်နေသော နေရာများ
    ...
    for (let day = 1; day <= daysInMonth; day++) {
        ...
        // ရက်စွဲကို နှိပ်လျှင် အသေးစိတ်ပြရန်
...
function showAppointments(dateStr) {
    ...
    // ထိုနေ့ရှိ လူနာများကို စစ်ထုတ်ခြင်း
            ...
            item.innerHTML = `
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    ...
                    <div style="text-align: right;">
                        <span style="color: white; font-size: 0.85rem; font-weight: bold;">${appt.time || 'အချိန်မရှိ'}</span>
