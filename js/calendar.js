...
// --- အချိန်မှန်အောင် ပြောင်းလဲပေးသည့် Function အသစ် ---
function formatTime(timeStr) {
    if (!timeStr) return "အချိန်မရှိ";
    
    let timePart = "";
    // Google Sheets က လာတဲ့ Date String ထဲက အချိန်အပိုင်းကိုပဲ ဆွဲထုတ်မယ်
    // ISO format "2026-02-21T09:00:00.000Z" ထဲက 09:00 ကိုပဲ ယူခြင်း
    ...
    const displayHours = hours % 12 || 12; // 0 နာရီကို 12 လို့ပြမယ်
...
function rebookPatient(name, phone, address) {
    ...
    showToast(`${name} ၏ အချက်အလက်များကို ဖြည့်ပြီးပါပြီ`);
}
